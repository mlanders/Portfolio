			...
			<Container>
				...
				<div>
					<Info>
						...
						<p>
							After ten years in the customer support industry, I've developed
							strong problem-solving and communication skills. I look forward to
							combining those skills to help build visually exciting projects.
						</p>{" "}
					</Info>
					<Skills>
						<h4>
